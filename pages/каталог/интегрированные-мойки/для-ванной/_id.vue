...
<div class="col-xs-12 nav-content">
          ...
          <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb" :class="{breadcrumb_open: showBreadcrumbsMobile}">
            ...
            <li class="breadcrumbs-links active" itemprop="itemListElement" itemscope
              itemtype="http://schema.org/ListItem">
                <nuxt-link to="../для-ванной/"  itemprop="item">
        ...
        <div class="col-xs-12 col-sm-6 col-md-7">
          <div class="img">
            <a :href="photo_main+'.png'" @click.prevent="openSuperModal=1">
              <picture>
                  <source type="image/webp" :srcset="photo_main+'.webp'" class="hover-effect-2" :alt="'Общий вид '+photo_name">
                  <source type="image/jpg" :srcset="photo_main+'.jpg'" class="hover-effect-2" :alt="'Общий вид '+photo_name">
                  <img :src="photo_main+'.jpg'" class="hover-effect-2" :alt="'Общий вид '+photo_name">
                </picture>
            </a>
                ...
                <span @click="openSuperModal=0" class="close-modal-stone">X</span>
                  <div class="row modal-stone-row">
                    ...
                    <div class="modal-stone-img-block">
                      <img :src="photo_main+'.jpg'" class="modal-stone-img" :alt="'Общий вид '+photo_name">
                    </div>
                    <div class="modal-stone-next modal-stone-prev-next-active" @click="openSuperModal = 2">&#8594;</div>
                  </div>
                <span class="title-modal-stone">Общий вид {{photo_name}}</span>
              </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-5">
          <div class="img">
            <a :href="photo_shema+'.png'"  @click.prevent="openSuperModal=2">
              <picture>
                  <source type="image/webp" :srcset="photo_shema+'.webp'" class="hover-effect-2" :alt="'Схема '+photo_name">
                  <source type="image/jpg" :srcset="photo_shema+'.jpg'" class="hover-effect-2" :alt="'Схема '+photo_name">
                  <img :src="photo_shema+'.jpg'" class="hover-effect-2" :alt="'Схема '+photo_name">
                </picture>
            </a>
            <div v-if="openSuperModal == 2"  class="modal-stone" >
                <span @click="openSuperModal=0" class="close-modal-stone">X</span>
                  <div class="row modal-stone-row">
                    ...
                    <div class="modal-stone-img-block">
                      <img :src="photo_shema+'.jpg'" class="modal-stone-img" :alt="'Схема '+photo_name">
                    </div>
                    <div class="modal-stone-next modal-stone-prev-next-active" @click="openSuperModal = 1">&#8594;</div>
                  </div>
                <span class="title-modal-stone">Схема {{photo_name}}</span>
              </div>
            </div>
          <p>
   ...
   components: {
    ...
    async asyncData({
        ...
        return await app.$axios
            .$get(
                `https://стильный-камень.рф/data/katalog/data_moyki.php?data=bath&url=${encodeURIComponent(uriPage)}`
            )
            .then((response) => {
                return {
