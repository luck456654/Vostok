...
<div class="col-xs-12 nav-content">
          ...
          <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb" :class="{breadcrumb_open: showBreadcrumbsMobile}">
            ...
            <li class="breadcrumbs-links active" itemprop="itemListElement" itemscope
              itemtype="http://schema.org/ListItem">
                <nuxt-link to="../мойки-из-кварцевого-камня-для-ванной.html"  itemprop="item">
                  <span itemprop="name">Мойки из кварцевого камня для ванной</span>
                 </nuxt-link>
        ...
        <div class="col-xs-12 col-sm-6 col-md-7">
          <div class="img">
            <a :href="photo_main+'.png'" @click.prevent="openSuperModal=1">
              <picture>
                  <source type="image/webp" :srcset="photo_main+'.webp'" class="hover-effect-2" :alt="'Общий вид '+photo_name+' из кварца'">
                  <source type="image/jpg" :srcset="photo_main+'.jpg'" class="hover-effect-2" :alt="'Общий вид '+photo_name+' из кварца'">
                  <img :src="photo_main+'.jpg'" class="hover-effect-2" :alt="'Общий вид '+photo_name+' из кварца'">
                </picture>
            </a>
                ...
                <span @click="openSuperModal=0" class="close-modal-stone">X</span>
                  <div class="row modal-stone-row">
                    ...
                    <div class="modal-stone-img-block">
                      <img :src="photo_main+'.jpg'" class="modal-stone-img" :alt="'Общий вид '+photo_name+' из кварца'">
                    </div>
                    <div class="modal-stone-next modal-stone-prev-next-active" @click="openSuperModal = 2">&#8594;</div>
                  </div>
                <span class="title-modal-stone">Общий вид {{photo_name}} из кварца</span>
              </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-5">
          <div class="img">
            <a :href="photo_shema+'.png'"  @click.prevent="openSuperModal=2">
              <picture>
                  <source type="image/webp" :srcset="photo_shema+'.webp'" class="hover-effect-2" :alt="'Схема '+photo_name+' из кварца'">
                  <source type="image/jpg" :srcset="photo_shema+'.jpg'" class="hover-effect-2" :alt="'Схема '+photo_name+' из кварца'">
                  <img :src="photo_shema+'.jpg'" class="hover-effect-2" :alt="'Схема '+photo_name+' из кварца'">
                </picture>
            </a>
            <div v-if="openSuperModal == 2"  class="modal-stone" >
                <span @click="openSuperModal=0" class="close-modal-stone">X</span>
                  <div class="row modal-stone-row">
                    ...
                    <div class="modal-stone-img-block">
                      <img :src="photo_shema+'.jpg'" class="modal-stone-img" :alt="'Схема '+photo_name+' из кварца'">
                    </div>
                    <div class="modal-stone-next modal-stone-prev-next-active" @click="openSuperModal = 1">&#8594;</div>
                  </div>
                <span class="title-modal-stone">Схема {{photo_name}} из кварца</span>
              </div>
            </div>
          <p>
    ...
    <div class="row">
      <div  class="nextblock2">
        <nuxt-link :to="prev_link" exact v-if="prev_link"><button type="button" class="btn btn-warning">Назад</button></nuxt-link>
        <nuxt-link :to="up_link" exact><button type="button" class="btn btn-warning">Вверх</button></nuxt-link>
        <nuxt-link :to="next_link" exact v-if="next_link"><button type="button" class="btn btn-warning">Вперед</button></nuxt-link>
      <br> <br>
    </div>
  </div>
</div>
...
export default {
   ...
   components: {
    ...
    data() {
        return {
          up_link:"../мойки-из-кварцевого-камня-для-ванной.html",
    ...
    async asyncData({
        ...
        return await app.$axios
            .$get(
                `https://стильный-камень.рф/data/katalog/data_moyki.php?data=kvartz_bath&url=${encodeURIComponent(uriPage)}`
            )
            .then((response) => {
                return {
